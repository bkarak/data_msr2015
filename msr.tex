...
% gousiosg: This is MSR -> no need of stating the obvious
% gousiosg: if you want, write a paragraph saying that science needs badly a dataset like the one you offer
...
%gousiosg: say how you identified java projects. Previous datasets failed to
% do this, therefore it is a strong point
...
% gousiosg: ref dimitro's paper and say you followed the same process
...
%is an open source tool that was developed by Diomidis Spinellis and then extended by Marian Jureczko. It
...
% A series of secondary metrics wesre also stored in the database. For example, a set of metrics that count the usage of specific {\sc dsl} application libraries in a software project. These are not included in the Table~\ref{tbl:selected-metrics}, since they are not commonly accepted. 
% dimitro@bkarak: then why do you mention it?
% gousiosg: @dimitro: I agree with your comment. However, identifying the 
% DSLs is a worthy contribution. @bkarak: I would rephrase and add a description of
% how you identified the DSLs. Then also mention this in the research
% opportunities
...
% gousiosg: A unique selling point is DSLs and people who want to do research with
% DSL embedding can use it I would add something here.
